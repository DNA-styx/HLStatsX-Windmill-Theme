...
*/
	...
	// Issue 7 fix: removed dead cookie/POST style selection block. $windmill_style is
	// set below directly from $g_options['style'] and the cookie logic never influenced it.

	// Control what pages are indexed by search engines
	if ($mode == 'contents') {
...
<head>
	...
	<!-- Issue 11 fix: pinned AlpineJS from floating v2.x.x to v2.8.2 -->
